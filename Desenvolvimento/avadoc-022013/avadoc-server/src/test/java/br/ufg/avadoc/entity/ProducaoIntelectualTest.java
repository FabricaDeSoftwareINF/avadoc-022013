...
public class ProducaoIntelectualTest {
	...
	public void testGetPontos() {
		...
		assertEquals(6, producaoIntelectual.getProducaoCientifica().getPontos(), DELTA);
		assertEquals(3, producaoIntelectual.getProducaoArtisticaCultural().getPontos(), DELTA);
		assertEquals(4, producaoIntelectual.getProducaoTecnicaTecnologica().getPontos(), DELTA);
		assertEquals(9, producaoIntelectual.getProducaoOutra().getPontos(), DELTA);
		
		assertEquals(22, producaoIntelectual.getPontos(), DELTA);
	}
