...
public class AtividadePesquisaExtensaoTest {
	...
	public void testGetPontos() {
		...
		assertEquals(6, atividadePesquisaExtensao.getPesquisa().getPontos(), DELTA);
		assertEquals(8, atividadePesquisaExtensao.getExtensao().getPontos(), DELTA);
		
		assertEquals(14, atividadePesquisaExtensao.getPontos(), DELTA);
	}
