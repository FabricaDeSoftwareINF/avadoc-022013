 ...
 * <a href="http://cavi.prodirh.ufg.br/uploads/65/original_Resolucao_CONSUNI_2009_0021.pdf">CONSUNI
 * 21/2009</a>
 * 
 */
public final class VerificaExigencias {
	...
	public static final class EstagioProbatorio {
		 ...
		 *            flag para verificar se o docente realizou
		 *            as atividades da PROGRAD e PRODIRH, Art. 8° da CONSUNI 21/2009.
		 * @param mediaN2
		 *            média das notas da chefia de gabinete ou da diretoria
		 *            no decorrer de 36 meses
		 * @param mediaN3
		 *            média das notas do corpo discente no decorrer de 36
		 *            meses
		 * @param medAtvInt
		 *            média das notas das atividades
		 *            intelecutais produzidas
		 * @param medAtvEns
		 *            médida média das notas das atividades de ensino
		 *            realizadas
		 * @param jorTra
		 *            especifica qual a jornada de trabalho do
		 *            docente
		 * @return verdadeiro para aprovado e falso para reprovado
		 */
		public static boolean verificaAprovacao(final Nota notaFinal, final boolean ocupaDirecao,
				final boolean participaPrograma, final double mediaN2, final double mediaN3, final double medAtvInt,
				final double medAtvEns, final EnumJornadaTrabalho jorTra) {

			final boolean exigI = verificaExigenciaI(medAtvEns, ocupaDirecao);
			final boolean exigII = verificaExigenciaII(medAtvInt, jorTra, medAtvEns);
		 ...
		 * 
		 * @param mediaAtvEns
		 *            média aritmética de pontos (E) no item I
		 *            Atividades de Ensino
		 * @param ocupaCargoDirecao
		 *            flag que verifica se o docente ocupa cargo
		 ...
		 *         (reprovado)
		 */
		private static boolean verificaExigenciaI(final double mediaAtvEns, final boolean ocupaCargoDirecao) {
		 ...
		 *            média aritmética de pontos nos
		 *            itens II-1, II-2 e II-3 (Produção Intelectual) e V-1
		 *            (Outras Atividades)
		 * @param jorTra
		 *            flag que verifica se o docente é de regime 40
		 ...
		 *            aplicada
		 * @param mediaAtvEns
		 *            valor da média nota do item I em
		 *            atividades de ensino
		 * @return verdadeiro (aprovado) para caso a média seja igual ou maior
		 *         que 20 por ano, caso contrário será falso (reprovado)
		 */
		private static boolean verificaExigenciaII(final double mediaProdIntel, final EnumJornadaTrabalho jorTra,
				final double mediaAtvEns) {
			double mediaRequerida = 20;
			if (mediaAtvEns >= 160 && !jorTra.equals(EnumJornadaTrabalho.jornada20)
		 ...
		 * 
		 * @param mediaN2
		 *            média final da nota da diretoria ou chefia de
		 *            gabinete
		 * @param mediaN3
		 ...
		 */
		private static boolean verificaExigenciaIII(final double mediaN2, final double mediaN3) {
			return mediaN2 >= EstagioProbatorio.MEDIA_N2 && mediaN3 >= EstagioProbatorio.MEDIA_N3;
		}
		 ...
		 * 
		 * @param partPrograma
		 *            flag que armazena se o docente participou
	...
	public static final class ProgressaoHorizontal {
		 ...
		 * @param medAtvInt
		 *            média dos itens II-1, II-2 e II-3 da Produção
		 *            Intelectual
		 * @param pontosAtvAcad
		 *            pontos do docente nos subitens 1, 2, 3 e 4 do
		 *            item V - Atividades Acadêmicas - Orientação
		 * @param desenvPosGrad
		 *            flag que informa se o docente desenvolveu
		 ...
		 * @param cargoDirecao
		 *            flag que indica se o docente ocupa algum cargo
		 *            de direção na UFG
		 * @param jorTra
		 ...
		 */
		public static boolean verificaAprovacao(final Nota ng, final double medAtvEns, final double medAtvInt,
				final double pontosAtvAcad, final boolean desenvPosGrad, final boolean afastado,
				final boolean cargoDirecao, final EnumJornadaTrabalho jorTra) {

			final boolean exigI = verificaExigenciaI(medAtvEns, desenvPosGrad, pontosAtvAcad, cargoDirecao, afastado);
			final boolean exigII = verificaExigenciaII(medAtvEns, medAtvInt, cargoDirecao, jorTra, afastado);
		 ...
		 * 
		 * @param medAtvEns
		 *            média das atividades de ensino do item I -
		 *            Atividades de Ensino
		 * @param desenvPosGrad
		 *            flag que informa se o docente desenvolveu
		 *            atividades de orientação de pós graduação <i>stricto sensu</i>
		 ...
		 *            item V - Atividades Acadêmicas - Orientação
		 * @param cargoDirecao
		 *            flag que informa se o docente ocupa um cargo de
		 *            direção na UFG
		 * @param afastado
		 *            flag que informa se o docente está afastado para a
		 *            realização de curso de pós graduação <i>stricto sensu</i>, estágio
		 ...
		 *         reprovado (falso)
		 */
		private static boolean verificaExigenciaI(final double medAtvEns, final boolean desenvPosGrad,
				final double pontosAtvAcad, final boolean cargoDirecao, final boolean afastado) {
		 ...
		 *            Intelectual
		 * @param cargoDirecao
		 *            flag que indica se o docente estiver ocupando
		 ...
		 *         e menor que 160
		 */
		private static boolean verificaExigenciaII(final double medAtvEns, final double medAtvInt,
				final boolean cargoDirecao, final EnumJornadaTrabalho jorTra, final boolean afastado) {
			...
			return afastado || cargoDirecao || medAtvEns == 160 || medAtvInt >= pontos
					|| jorTra.equals(EnumJornadaTrabalho.jornada20);
		}
