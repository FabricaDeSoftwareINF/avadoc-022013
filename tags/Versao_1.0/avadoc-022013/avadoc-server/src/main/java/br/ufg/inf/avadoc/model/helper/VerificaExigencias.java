 ...
 * no <b>Art.27</b> e <b>Art.16</b> da <b>CONSUNI 21/2009</b>, disponível em: <br>
 * <a href=
 * "http://cavi.prodirh.ufg.br/uploads/65/original_Resolucao_CONSUNI_2009_0021.pdf"
 * >CONSUNI 21/2009</a>
 * 
 */
public final class VerificaExigencias {
	...
	public static final class EstagioProbatorio {
		...
		/**
		 * Média final da nota do corpo discente ao final de 36 meses em estágio
		 * probatório.
		 */
		 ...
		 * 
		 * @param notaFinal
		 *            nota final do docente ao longo de 36 meses.
		 * @param ocupaDirecao
		 *            flag para verificar se o docente ocupa cargo de
		 *            direção/administrativa
		 * @param participaPrograma
		 *            flag para verificar se o docente realizou as atividades da
		 *            PROGRAD e PRODIRH, Art. 8° da CONSUNI 21/2009.
		 * @param mediaN2
		 *            média das notas da chefia de gabinete ou da diretoria no
		 *            decorrer de 36 meses
		 * @param mediaN3
		 *            média das notas do corpo discente no decorrer de 36 meses
		 * @param medAtvInt
		 *            média das notas das atividades intelecutais produzidas
		 * @param medAtvEns
		 *            médida média das notas das atividades de ensino realizadas
		 * @param jorTra
		 *            especifica qual a jornada de trabalho do docente
		 ...
		 * 
		 * @param mediaAtvEns
		 *            média aritmética de pontos (E) no item I Atividades de
		 *            Ensino
		 * @param ocupaCargoDirecao
		 *            flag que verifica se o docente ocupa cargo na direção. Se
		 *            for verdadeiro, a regra será desconsiderada, senão será
		 *            considerada
		 * @return verdadeiro (aprovado) caso a média seja igual ou maior que
		 *         80.0 no item I Atividades de Ensino, caso contrário será
		 *         falso (reprovado)
		 */
		 ...
		 * itens II-1, II-2 e II-3 (Produção Intelectual) e V-1 (Outras
		 * Atividades).
		 * 
		 * @param mediaProdIntel
		 *            média aritmética de pontos nos itens II-1, II-2 e II-3
		 *            (Produção Intelectual) e V-1 (Outras Atividades)
		 * @param jorTra
		 *            flag que verifica se o docente é de regime 40 horas ou
		 *            Dedicação exclusiva, se for verdadeiro, a regra se aplica,
		 *            caso contrário o mesmo é de regime de 20 horas e tal regra
		 *            não será aplicada
		 * @param mediaAtvEns
		 *            valor da média nota do item I em atividades de ensino
		 ...
		 * 
		 * @param mediaN2
		 *            média final da nota da diretoria ou chefia de gabinete
		 * @param mediaN3
		 *            média final da nota do corpo discente
		 * @return verdadeiro (aprovado) para caso a ambas as médias sejam
		 *         maiores ou iguais a 5.0, caso contrário será falso
		 *         (reprovado)
		 */
		private static boolean verificaExigenciaIII(final double mediaN2,
				final double mediaN3) {
			return mediaN2 >= EstagioProbatorio.MEDIA_N2
					&& mediaN3 >= EstagioProbatorio.MEDIA_N3;
		}

		/**
		 * Método que verifica se o docente participou do programa de atividades
		 * de responsabilidade da PROGRAD e PRODIRH, Art. 8° da CONSUNI 21/2009.
		 * 
		 * @param partPrograma
		 *            flag que armazena se o docente participou ou não dos
		 *            programas
		...
		private static boolean verificaExigenciaV(final Nota notaFinal) {
			return notaFinal.getNota() >= EstagioProbatorio.MEDIA_FINAL;
		}
	...
	public static final class ProgressaoHorizontal {
		 ...
		 * 
		 * @param ng
		 *            nota global do docente que está em progressão horizontal
		 * @param medAtvEns
		 *            média das atividades de ensino (item I)
		 * @param medAtvInt
		 *            média dos itens II-1, II-2 e II-3 da Produção Intelectual
		 * @param pontosAtvAcad
		 *            pontos do docente nos subitens 1, 2, 3 e 4 do item V -
		 *            Atividades Acadêmicas - Orientação
		 * @param desenvPosGrad
		 *            flag que informa se o docente desenvolveu atividades de
		 *            orientação de pós graduação <i>stricto sensu</i>
		 * @param afastado
		 *            flag que informa se o docente está afastado para a
		 *            realização de curso de pós graduação <i>stricto sensu</i>,
		 *            estágio pós-doutoral ou estágio sênior
		 * @param cargoDirecao
		 *            flag que indica se o docente ocupa algum cargo de direção
		 *            na UFG
		 * @param jorTra
		...
		public static boolean verificaAprovacao(final Nota ng,
			...
			final boolean exigI = verificaExigenciaI(medAtvEns, desenvPosGrad,
					pontosAtvAcad, cargoDirecao, afastado);
			final boolean exigII = verificaExigenciaII(medAtvEns, medAtvInt,
					cargoDirecao, jorTra, afastado);
			final boolean exigIII = verificaExigenciaIII(ng);
		 ...
		 * docente tem uma média aritmética igual ou superior a 80 (ou 60 caso o
		 * mesmo tenha desenvolvido atividades de orientação na pós-Graduação
		 ...
		 * 
		 * @param medAtvEns
		 *            média das atividades de ensino do item I - Atividades de
		 *            Ensino
		 * @param desenvPosGrad
		 *            flag que informa se o docente desenvolveu atividades de
		 *            orientação de pós graduação <i>stricto sensu</i>
		 ...
		 *            Atividades Acadêmicas - Orientação
		 * @param cargoDirecao
		 *            flag que informa se o docente ocupa um cargo de direção na
		 *            UFG
		 * @param afastado
		 *            flag que informa se o docente está afastado para a
		 *            realização de curso de pós graduação <i>stricto sensu</i>,
		 ...
		 *         direção, estiver afastado ou obter uma média de atividades de
		 *         ensino maior ou igual à média estabelecida acima. Caso
		 *         contrário será reprovado (falso)
		 */
		 ...
		 *            média dos itens II-1, II-2 e II-3 da Produção Intelectual
		 * @param cargoDirecao
		 *            flag que indica se o docente estiver ocupando um cargo de
		 *            direção na UFG
		 * @param jorTra
		 *            especifica a jornada de trabalho do docente
		 * @param afastado
		 *            flag que indica
		 * @return aprovado (verdadeiro) para quando o docente ocupar cargo de
		 *         direção, estiver afastado, ter uma jornada de trabalho de 20
		 *         horas, ter a média de atividades de ensino igual a 160 ou a
		 *         média de atividades intelectuais maior ou igual a 20 pontos
		 *         (ou pela fórmula (40 - E / 4) onde "E" é a pontuação média
		 *         obtida no item I - Atividades de Ensino caso a mesma tenha
		 *         pontuação média maior que 80 e menor que 160
		 */
		...
		/**
		 * Verifica se a nota global obtida pelo docente é maior ou igual a 7,5
		 * na avaliação definida no Art. 26 da CONSUNI 21/2009.
		 * 
		 * @param notaGlobal
		 *            nota global do docente em progressão horizontal
		 * @return verdadeiro para aprovado e falso para reprovado
		 */
		private static boolean verificaExigenciaIII(final Nota notaGlobal) {
			return notaGlobal.getNota() >= ProgressaoHorizontal.MEDIA_GLOBAL;
		}
	}
}
