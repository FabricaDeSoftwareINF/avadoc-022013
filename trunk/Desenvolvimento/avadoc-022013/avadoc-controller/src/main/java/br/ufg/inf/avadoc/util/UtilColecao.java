 ...
 * 
 * <p>
 * <b>Description:</b> Classe utilitária para manipular Coleções.
 * </p>
 * 
...
public class UtilColecao {
	 ...
	 * @see Comparator
	 */
	public static <T> Collection<T> ordenar(final Collection<T> colecao,
	 ...
	 */
	public static <T> T getElementoDoIndice(final List<T> lista,
			final int indice) {
	 ...
	 * @return Objeto do índice
	 */
	public static <T> T getElementoDoIndice(final Collection<T> colecao,
			final int indice) {
